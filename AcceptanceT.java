...
public class AcceptanceT {
	...
	public static void setupWebdriverChromeDriver() {
		...
		// "/src/test/resources/operaDriver.exe");
	}
	...
	public void testWebInterface() throws InterruptedException {
		...
		// if the states are not equals (for example first state 'running' and second
		// 'hardware issue') the values should be the same
		else
			Assert.assertEquals(afterR2, beforeR2);
	}
	...
	public void testRebootButton() {
		...
		// seconds are required by WebDriverWait, so 1000 seconds are just a way to say
		// 'don't throw an exception for a long time'
